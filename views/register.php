...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>Register Akun SIWPOK</a>
  </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-8">
            <div class="custom-control custom-radio custom-control-inline">
              <input name="role" id="role_0" type="radio" class="custom-control-input" value="administrator" aria-describedby="roleHelpBlock" id="flexCheckDisabled" disabled>
              <label for="role_0" class="custom-control-label">Administrator</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input name="role" id="role_1" type="radio" class="custom-control-input" value="public" aria-describedby="roleHelpBlock" required> 
